// angular.module('hashBang.graphics.controllers', [])

// .controller('Step01AnimationController', function(hashFunctions, $stateParams, $rootScope, $scope, $state, $interval, $famous, $timeline, stateTransitions, $media) {
